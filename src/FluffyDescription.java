...
public class FluffyDescription {
        ...
        private String[] action = {"hanging from the ceiling", "raining down from above", "slowly," +
                ...
                "swinging from outcroppings near the ceiling"};
        private String[] decoration = {"mushrooms", "fungus", "rocks", "skulls", "sticky webs", "icy spirals", "plants"};

        private String[] roomNames = {" cave.", " grotto.", " room.", " hollow.", " tunnel.", " dug-out.", " chamber"};
        private String[] roomDescriptor = {"The bloody", "The hollow", "The chilly", "The harsh", "The still",
                "The turbulent", "The small", "The deathly", "The tiresome", "The gross"};
